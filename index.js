...
const token = "6624846335:AAGX8l0rTpMYJ5Mafx5BanHdxQs7gdbnxjQ";
...
bot.on("message", async (msg) => {
  ...
  try {
    const response = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=45aa1465d99fdfa719a0a1dabb1f0e70
      `
    );
